...
const User = () => {
  ...
  // Creates the header element by iterating over the headers array, since ReactNode element can only be rendered.
  // As can see if the header element is date (or) time then, added the sort functionality.
  ...
  // Create the ReactNode elements for rendering of the users data.
  ...
  // Update the displayUsers array based on the sortType and sort directions.
  useEffect(() => {
    if (sortType === "date") {
  ...
  // Functiona handler for pagination
  function handlePagination(i) {
    // calculate the start an end index
